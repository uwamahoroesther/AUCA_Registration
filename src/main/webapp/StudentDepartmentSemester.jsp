...
<div class="container">
    ...
    <form class="form-inline mt-3" method="post" action="StudentDepartmentSemester.jsp">
    ...
    <%
        ...
        if (selectedSemester != null && selecteddepartment != null) {
            ...
            List<StudentRegistration> studentList = infc.getStudentsByDepartmentAndSemester(acc,semester);
    ...
    <table class="table table-bordered table-striped mt-3">
        ...
        <%
            if (selectedSemester != null && selecteddepartment != null) {
                ...
                StudentRegInterface ifc = new StudentRegService();
                List<StudentRegistration> studentListe = ifc.getStudentsByDepartmentAndSemester(ac, sem);
                for (StudentRegistration std : studentListe) {
        %>
        <tr>
            <td><%= std.getStudentId() %></td>
            <td><%= std.getStudent().getfName() %></td>
            <td><%= std.getStudent().getlName() %></td>
            <td><%= std.getStudent().getDateOfBirth() %></td>
        </tr>
        <%
                }
            }
